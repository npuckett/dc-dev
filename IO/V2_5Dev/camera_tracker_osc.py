...
# Config files live in parent IO/ directory for shared access
CALIBRATION_FILE = os.path.join(_PARENT_DIR, 'camera_calibration.json')
...
class TrackerSettings:
    ...
    SLIDER_DEFS = {
        'confidence':  {'min': 10, 'max': 80, 'scale': 100, 'label': 'Confidence'},
        'fusion_dist': {'min': 50, 'max': 300, 'scale': 1,  'label': 'Fusion Dist cm'},
        'smoothing':   {'min': 1,  'max': 20,  'scale': 100, 'label': 'Smoothing'},
    }
